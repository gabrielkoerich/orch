...
**5 commits** landed today, headlined by a notable revert and a fresh parser fix.
...
| `92c98607` | #3334 | fix(router): skip agent dispatch for repos with active GitHub Actions billing failures *(reverted)* |
